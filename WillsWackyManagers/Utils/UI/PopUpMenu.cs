...
namespace WillsWackyManagers.Utils.UI
{
    class PopUpMenu : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            var layoutGroup = this.gameObject.GetOrAddComponent<VerticalLayoutGroup>();
            layoutGroup.childAlignment = TextAnchor.MiddleCenter;

            var sizer = this.gameObject.GetOrAddComponent<ContentSizeFitter>();
        ...
        public void Open(List<string> choices, Action<string> callback)
        {
            ...
            for (int i = 0; i < this.choices.Count; i++)
            {
                ...
                var particle = go.GetComponentInChildren<GeneralParticleSystem>();
                particle.Stop();
            }
